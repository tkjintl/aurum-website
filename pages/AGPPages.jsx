          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12 }}>
            {STEPS.map((s, i) => (
              <div key={i} onClick={() => setStep(i)} style={{
                ...
                <div>
                  <div style={{ fontFamily: T.mono, fontSize: 11, color: T.gold, marginBottom: 3 }}>{String(i + 1).padStart(2, '0')}</div>
        ...
        {formStep === 2 && (
          <div>
            ...
            <div style={{ marginBottom: 24 }}>
              <label style={{ fontFamily: T.mono, fontSize: 11, letterSpacing: '0.16em', textTransform: 'uppercase', color: T.goldDim, display: 'block', marginBottom: 18 }}>월 적립액 · MONTHLY CONTRIBUTION</label>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 8, fontFamily: T.mono, fontSize: 11, color: T.textMuted, letterSpacing: '0.10em' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontFamily: T.mono, fontSize: 11, letterSpacing: '0.16em', color: T.goldDim, display: 'block', marginBottom: 10 }}>적립 주기</label>
