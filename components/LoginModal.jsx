...
export default function LoginModal({ show, onClose, onLogin, lang }) {
  ...
  const inp = {
    ...
    color:T.text, padding:'12px 16px', fontSize:16, outline:'none',
  ...
  return (
    <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.8)', zIndex:1000, display:'flex', alignItems:'center', justifyContent:'center', padding:20 }}
      ...
      <div style={{ background:T.bg1, border:`1px solid ${T.goldBorder}`, padding:40, width:'100%', maxWidth:440, position:'relative' }}
        ...
        <div style={{ fontFamily:T.mono, fontSize:11, letterSpacing:'0.22em', color:T.gold, textTransform:'uppercase', marginBottom:20 }}>
