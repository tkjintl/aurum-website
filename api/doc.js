...
const DOCS = {
  package:    { file: 'TACC_Onboarding_May_2026.pdf', label: 'TACC Onboarding · May 2026' },
  structural: { file: 'TACC_Structural_Memo.pdf',     label: 'TACC Structural Memo' },
  faq:        { file: 'TACC_Member_FAQ.pdf',          label: 'TACC Member FAQ' },
};
